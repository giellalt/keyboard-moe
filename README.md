<<<<<<< HEAD
The Innu morphology and tools
==========================================

[![Maturity](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgiellalt%2Fkeyboard-moe%2Fmain%2Fdocs%2Fbadgedata%2Ffst-maturity.json)](https://giellalt.github.io/MaturityClassification.html)
![Lemma count](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fgiellalt%2Fkeyboard-moe%2Fmain%2Fdocs%2Fbadgedata%2Ffst-lemmacount.json)
[![GitHub issues](https://img.shields.io/github/issues-raw/giellalt/keyboard-moe)](https://github.com/giellalt/keyboard-moe/issues)
[![License](https://img.shields.io/github/license/giellalt/keyboard-moe)](https://github.com/giellalt/keyboard-moe/blob/main/LICENSE)
[![Doc build](https://img.shields.io/github/actions/workflow/status/giellalt/keyboard-moe/docs.yml?logo=github&label=DocCI)](https://github.com/giellalt/keyboard-moe/actions/workflows/docs.yml)
[![Build Status](https://builds.giellalt.org/api/badge/keyboard-moe?logo=buildkite&label=CoreCI)](https://builds.giellalt.org/pipelines/keyboard-moe/builds/latest)

Download nightly / CI/CD installation packages for testing (contains the core zhfst file(s)):

[![Windows](https://img.shields.io/badge/download%40latest-Windows--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-moe?platform=windows&channel=nightly)
[![MacOS](https://img.shields.io/badge/download%40latest-macOS--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-moe?platform=macos&channel=nightly)
[![Mobile](https://img.shields.io/badge/download%40latest-mobile--bhfst-brightgreen)](https://pahkat.uit.no/main/download/speller-moe?platform=mobile&channel=nightly)
...
This repository contains finite state source files for the Innu language
(ISO 639-3: moe, glottolog: mont1268),
for building morphological analysers, proofing tools
and dictionaries. The data and implementation are licenced under __LICENCE__
licence, also detailed in the
[LICENSE](https://github.com/giellalt/keyboard-moe/blob/main/LICENSE). The
authors named in the AUTHORS file are available to grant other licencing
choices.

Install proofing tools and [keyboards](https://github.com/giellalt/keyboard-moe)
for the Innu language by using the [Divvun Installer](http://divvun.no)
(some languages are only available via the nightly channel).

Spell-checker accuracy:

[![Speller
Accuracy](https://img.shields.io/badge/Speller_Accuracy-XX_%25-green.svg)](https://giellalt.github.io/keyboard-moe/speller-report.html)
[![Spell-checking accuracy development
graph](https://giellalt.github.io/keyboard-moe/speller-report.svg)](https://giellalt.github.io/keyboard-moe/speller-report.svg)
...
- [Language specific documentation](https://giellalt.github.io/keyboard-moe/)
- [General documentation](https://giellalt.github.io/)

Core dependencies
-----------------

In order to compile and use Innu language morphology and
...
Using Git:
```
git clone https://github.com/giellalt/keyboard-moe
```

Using Subversion:
```
svn checkout https://github.com/giellalt/keyboard-moe.git/trunk keyboard-moe
```

Building and installation
-------------------------

[INSTALL](https://github.com/giellalt/keyboard-moe/blob/main/INSTALL)
...
[![GitHub issues](https://img.shields.io/github/issues-raw/giellalt/keyboard-moe)](https://github.com/giellalt/keyboard-moe/issues)
[![Build Status](https://github.com/giellalt/keyboard-moe/workflows/Build%20Keyboards/badge.svg)](https://github.com/giellalt/keyboard-moe/actions)
[![Doc Status](https://github.com/giellalt/keyboard-moe/workflows/Build%20Docs/badge.svg)](https://github.com/giellalt/keyboard-moe/actions)
[![License](https://img.shields.io/github/license/giellalt/keyboard-moe)](https://github.com/giellalt/keyboard-moe/blob/main/LICENSE)

This repository contains source files for
keyboards for the Innu language. The code
